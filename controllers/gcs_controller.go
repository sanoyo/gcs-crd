...
// GcsReconciler reconciles a Gcs object
type GcsReconciler struct {
	client.Client
...
// the Gcs object against the actual cluster state, and then
...
func (r *GcsReconciler) SetupWithManager(mgr ctrl.Manager) error {
